...
You can also ask for a check directly:

> Give me a Feynman check on mastery scores.

The goal is not to pass a quiz. The goal is to make your understanding visible enough that the agent can teach the next useful thing.
