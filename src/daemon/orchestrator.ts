...
export const buildTurnPrompt = (input: TurnPromptInput): string =>
  [
    ...
    "The conversation response must contain only learner-facing teaching prose. Never include internal planning, tool or command names, calibration notes, course-state summaries, scratchpad reasoning, or commentary about what you will do before replying. If your harness has a thinking/reasoning channel, put that material there; otherwise keep it private.",
